...
export const characters = [
  ...
  { id: 'misae', name: '伊吹 公子', avatar: AvatarMisae, tachie: TachieMisae, description: '宿舍管理员' },
  { id: 'kouko', name: '春原 阳平', avatar: AvatarKouko, tachie: TachieKouko, description: '主角的好友' },
